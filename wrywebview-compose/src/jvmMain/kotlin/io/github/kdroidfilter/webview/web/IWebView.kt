...
typealias NativeWebView = io.github.kdroidfilter.webview.wry.WryWebViewPanel

/**
 * Platform WebView abstraction (API compatibility).
 *
 * This repository provides a Desktop/JVM implementation backed by Wry.
 */
interface IWebView {
