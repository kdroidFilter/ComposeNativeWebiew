        ...
        Column(
            ...
            SectionCard(title = "Headers & Interceptor") {
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Text("Send custom header on navigation", style = MaterialTheme.typography.bodyMedium)
                }
            ...
            SectionCard(title = "Cookies") {
                Text(
                    text = "Backed by Wry cookie APIs (set/get/remove).",
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant,
                )
                Spacer(Modifier.height(8.dp))
            ...
            SectionCard(title = "JavaScript") {
                Text(
                    text = "evaluateJavaScript is currently fire-and-forget on Desktop/Wry.",
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant,
                )
                Spacer(Modifier.height(8.dp))
            ...
            SectionCard(title = "Settings") {
                Text(
                    text = "These settings are mostly kept for API compatibility (only logging applies today).",
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant,
                )
                Spacer(Modifier.height(8.dp))
                ...
                OutlinedTextField(
                    ...
                    singleLine = true,
                    label = { Text("Custom User-Agent (recreates WebView)") },
                )
            }
...
private fun inlineHtml(): String =
    ...
    <body>
      ...
      <p>This content is loaded via <code>loadHtml</code> on the Wry backend.</p>
      <div class="card">
        <div id="time"></div>
